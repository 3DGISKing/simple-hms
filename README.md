...
├── data/
├── screenshots/          # GUI screenshot for README
...
Questions are grouped by category, then alphabetically within each category. Each question has a unique number (Q1–Q29).

---

### 2D shallow water

#### Q1. What is 2D diffusive wave?
...
#### Q2. Which is better: full shallow water or 2D diffusive wave?
...
#### Q3. How do I add base flow to the hydrograph?
...
#### Q6. Can this generate flood maps?
...
#### Q7. What is Q-to-stage in the plan?
...
#### Q8. What is a rating curve? How is it generated?
...
#### Q10. Can the hydrograph be used as an upstream boundary condition for HEC-RAS or shallow water models?
...
#### Q11. Does the hydrograph have meaning for the outlet?
...
#### Q12. Can I use any rainfall depth and duration (e.g., 150 mm over 10 min)?
...
#### Q13. I only have DEM and CN map. What else do I need?
...
#### Q14. What is P2 (2-yr 24-hr rainfall)?
...
#### Q15. Is the current transform (SCS UH) better than Clark or Snyder?
...
#### Q17. What is transform (in Possible Updates)?
...
#### Q18. What parameters would Clark or Snyder UH require?
...
#### Q19. What parameters would Green-Ampt require?
...
#### Q20. How is the outlet specified?
...
#### Q21. Why can't the outlet be auto-detected?
...
#### Q22. Can SCS Type I/II/III be used for non-USA areas?
...
#### Q23. How do I use the uniform pattern?
...
#### Q24. What are the other pattern types?
...
#### Q26. What are lag and Muskingum routing? What are the differences and pros/cons?
...
#### Q27. What changes when using subbasin mode vs lumped?
...
#### Q28. How is time of concentration (Tc) computed?
